...
::grpc::Status CppAImpl::Cpp_A_1(::grpc::ServerContext *context,
                                 const ::protos::CommonMessage *request,
                                 ::protos::CommonMessage *response) {
  cnt++;
  *response = *request;
  response->set_my_string("Cpp_A_1");
  if (cnt > 1000) {
  ...
  try {
    ...
    Cpp_A_2(context, response, &new_response);

    {
      ...
      stub->Cpp_B_2(&new_context, new_request, &new_response);
    }

    {
      auto ch = ::grpc::CreateChannel("python_b:8080",
                                      grpc::InsecureChannelCredentials());
      auto stub = ::Python_B::NewStub(ch);
      ::protos::CommonMessage new_response;
      ::grpc::ClientContext new_context;
      ::protos::CommonMessage new_request = *response;
      stub->Python_B_2(&new_context, new_request, &new_response);
    }
  ...
  response->add_call_stack("Cpp_A_1");
  return ::grpc::Status::OK;
}

::grpc::Status CppAImpl::Cpp_A_2(::grpc::ServerContext *context,
                                 const ::protos::CommonMessage *request,
                                 ::protos::CommonMessage *response) {
  cnt++;
  *response = *request;
  response->set_my_string("Cpp_A_2");
  if (cnt > 1000) {
    uint32_t choice = rand();
    if (choice % 100 == 0) {
      throw std::runtime_error("fail");
  ...
  try {
    {
      auto ch = ::grpc::CreateChannel("ts_b:8080",
                                      grpc::InsecureChannelCredentials());
      auto stub = ::Ts_B::NewStub(ch);
      ::protos::CommonMessage new_response;
      ::grpc::ClientContext new_context;
      ::protos::CommonMessage new_request = *response;
      stub->Ts_B_1(&new_context, new_request, &new_response);
    }

    {
      ...
      ::grpc::ClientContext new_context;
      ::protos::CommonMessage new_request = *response;
      stub->Ts_B_3(&new_context, new_request, &new_response);
    }
  ...
  response->add_call_stack("Cpp_A_2");
  return ::grpc::Status::OK;
}

::grpc::Status CppAImpl::Cpp_A_3(::grpc::ServerContext *context,
                                 const ::protos::CommonMessage *request,
                                 ::protos::CommonMessage *response) {
  cnt++;
  *response = *request;
  response->set_my_string("Cpp_A_3");
  if (cnt > 1000) {
    uint32_t choice = rand();
    if (choice % 100 == 0) {
      throw std::runtime_error("fail");
  ...
  response->add_call_stack("Cpp_A_3");
  return ::grpc::Status::OK;
}
