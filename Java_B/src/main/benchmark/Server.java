...
public class Server {
  ...
  static class Java_BImpl extends Java_BGrpc.Java_BImplBase {
    int cnt = 0;
    ...
    public void javaB1(
      ...
      try {
        javaB3(new_request, responseObserver);
      ...
      response = Message.CommonMessage.newBuilder().mergeFrom(response).addCallStack("Java_B_1").build();
    ...
    public void javaB2(
      ...
      try {
...

        {
          ManagedChannel channel = Grpc.newChannelBuilder("java_c:8080",
              ...
              .build();
          Java_CGrpc.Java_CBlockingStub blockingStub = Java_CGrpc.newBlockingStub(channel);
          blockingStub.javaC2(new_request);
        }
      ...
      response = Message.CommonMessage.newBuilder().mergeFrom(response).addCallStack("Java_B_2").build();
      responseObserver.onNext(response);
      responseObserver.onCompleted();
      return;
    }
    ...
    public void javaB3(
      ...
      try {
...

        {
          ManagedChannel channel = Grpc.newChannelBuilder("java_c:8080",
              ...
              .build();
          Java_CGrpc.Java_CBlockingStub blockingStub = Java_CGrpc.newBlockingStub(channel);
          blockingStub.javaC3(new_request);
        }
      ...
      response = Message.CommonMessage.newBuilder().mergeFrom(response).addCallStack("Java_B_3").build();
      responseObserver.onNext(response);
      responseObserver.onCompleted();
      return;
    }
